import os, json, time, threading, requests, schedule, smtplib
...
# ✅ Load token info from access_token.json
...
def place_order(symbol, side, qty):
    try:
        ...
        order = {
            "variety": "NORMAL",
            "tradingsymbol": sym,
            "symboltoken": "3045",  # Replace dynamically later
...
def start_scheduler():
    schedule.every().day.at("09:15").do(lambda: run_trading_bot(True))
...
# ✅ Streamlit UI
st.set_page_config(page_title="Angel One AI Trading", layout="wide")
